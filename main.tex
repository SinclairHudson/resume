...
\maintitle{Sinclair Hudson}{University of Toronto MSc of Applied Computing, graduating Dec 2024}
...
\item Developed a set of debugging tools to assist in model deployment, reducing deployment time by days in some cases.
...
\item Designed and created an anomaly detection research repository in PyTorch, for interal research detecting anomalies in images.
