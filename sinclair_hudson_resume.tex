...
\maintitle{Sinclair Hudson}{Machine Learning Researcher and Developer}
...
\spacedhrule{0.0em}{-0.6em} % Horizontal rule - the first bracket is whitespace before and the second is after
